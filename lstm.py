...
drop_cols = ['athlete_id', 'date']  # Remove non-numeric identifiers
...
# We'll use a fixed window size for each athlete
...
print("Injury risk prediction:", "Injured" if predicted_class[0][0] == 1 else "Not Injured")

# Save model architecture + weights
model.save("athlete_injury_lstm_model.h5")
print("✅ Model saved as 'athlete_injury_lstm_model.h5'")